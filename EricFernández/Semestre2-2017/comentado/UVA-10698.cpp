...
using namespace std;
/*
El problema consiste en leer los resultados de los equipos de balonpie xD, y imprimir una tabla ordenada
con ciertas caracteristicas

*/
/*
Define una estructura para los equipos bastante bonita a decir verdad
*/
struct team{
	...
	//como dice el nombre, esta muchachona es la encargada de imprimir la estadistica
	void print(int rank){
...
bool cmp(const team* a, const team* b){
	/*
	retorna la informacion necesaria, si los puntos son distitnos
	si los goles son distintos y las combinaciones entre ambos
	*/
...
int main(){
	cout.precision(2);
	cout << fixed;
	//Crea el mapa (que ordena altiro ), con la clave el equipo, y el valor las estadisticas de este
	map<string,team> m;
	...
	while(cin >> a >> b,a||b){
		...
		//limpia el mapa para una nueva entrada
		m.clear();
		//le los datos
		for(int i=0;i<a;i++){
			cin >> s;
		...
		vector<team*> v;
		//con el mapita llenito lo recorre
